...
class RuntimeProfile:
    ...
    selfplay_max_game_length: int
    selfplay_force_random_plies: int
    selfplay_resign_after_plies: int
    selfplay_resign_value_threshold: float
    selfplay_resign_streak: int
    selfplay_avoid_draw_repetition_plies: int
    selfplay_capped_value_threshold: float
    selfplay_capped_material_threshold: float
...
LOCAL_PROFILE = RuntimeProfile(
    ...
    selfplay_max_game_length=160,
    selfplay_force_random_plies=8,
    selfplay_resign_after_plies=24,
    selfplay_resign_value_threshold=-0.92,
    selfplay_resign_streak=3,
    selfplay_avoid_draw_repetition_plies=120,
    selfplay_capped_value_threshold=0.72,
    selfplay_capped_material_threshold=1.5,
...
LOCAL_ALPHAFOLD_PROFILE = RuntimeProfile(
    name="local_alphafold",
    ...
    model_channels=128,
    policy_head_channels=32,
    value_head_hidden=160,
    replay_encoder_version=6,
    replay_compress=True,
    min_samples_ready=20_000,
    train_increment=20_000,
    replay_window_samples=120_000,
    train_samples_per_cycle=24_000,
    bootstrap_window_samples=80_000,
    max_retained_samples=150_000,
    train_batch_size=32,
    train_epochs_per_cycle=1,
    ...
    selfplay_capped_value_threshold=0.72,
    selfplay_capped_material_threshold=1.5,
    arena_simulations=64,
    arena_promotion_games=12,
    arena_baseline_games=4,
    arena_promotion_threshold=0.55,
    inference_single_batch=16,
    inference_merged_batch=16,
    inference_wait_timeout=0.0001,
    inference_compile=False,
...
MPS_ALPHAFOLD_PROFILE = RuntimeProfile(
    name="mps_alphafold",
    input_history_length=8,
    piece_planes_per_position=12,
    aux_planes=8,
    ...
    replay_encoder_version=6,
    replay_compress=True,
    min_samples_ready=30_000,
    train_increment=20_000,
    replay_window_samples=180_000,
    train_samples_per_cycle=48_000,
    bootstrap_window_samples=100_000,
    max_retained_samples=250_000,
    train_batch_size=64,
    train_epochs_per_cycle=1,
    train_poll_interval_s=5.0,
    train_optimizer="adamw",
    ...
    selfplay_capped_value_threshold=0.72,
    selfplay_capped_material_threshold=1.5,
    arena_simulations=128,
    arena_promotion_games=16,
    arena_baseline_games=6,
    arena_promotion_threshold=0.55,
    inference_single_batch=32,
    inference_merged_batch=64,
    inference_wait_timeout=0.0003,
    inference_compile=False,
    inference_precision="fp16",
)


MPS_COLLECT_PROFILE = RuntimeProfile(
    name="mps_collect",
    input_history_length=8,
    piece_planes_per_position=12,
    aux_planes=8,
    ...
    min_samples_ready=16_000,
    train_increment=12_000,
    replay_window_samples=120_000,
    train_samples_per_cycle=32_000,
    bootstrap_window_samples=80_000,
    ...
    selfplay_max_game_length=56,
    selfplay_force_random_plies=12,
    selfplay_resign_after_plies=8,
    selfplay_resign_value_threshold=-0.68,
    selfplay_resign_streak=1,
    selfplay_avoid_draw_repetition_plies=32,
    selfplay_capped_value_threshold=0.40,
    selfplay_capped_material_threshold=0.25,
    arena_simulations=128,
    arena_promotion_games=12,
    arena_baseline_games=4,
    arena_promotion_threshold=0.55,
...
MPS_FAST_PROFILE = RuntimeProfile(
    ...
    selfplay_max_game_length=128,
    selfplay_force_random_plies=6,
    selfplay_resign_after_plies=18,
    selfplay_resign_value_threshold=-0.90,
    selfplay_resign_streak=2,
    selfplay_avoid_draw_repetition_plies=84,
    selfplay_capped_value_threshold=0.50,
    selfplay_capped_material_threshold=0.75,
    arena_simulations=96,
    arena_promotion_games=12,
    arena_baseline_games=4,
    arena_promotion_threshold=0.55,
...
PROFILES = {
    ...
    LOCAL_ALPHAFOLD_PROFILE.name: LOCAL_ALPHAFOLD_PROFILE,
    MPS_PROFILE.name: MPS_PROFILE,
    MPS_ALPHAFOLD_PROFILE.name: MPS_ALPHAFOLD_PROFILE,
    MPS_COLLECT_PROFILE.name: MPS_COLLECT_PROFILE,
