...
function render(state) {
    ...
    details.innerHTML = [
        ...
        ["Arena Search", profile.arena_simulations ? `${fmtInt(profile.arena_simulations)} sims / move` : "n/a"],
        ["Inference Precision", String(profile.inference_precision || "fp32").toUpperCase()],
        ["External Games", profile.arena_baseline_games ? fmtInt(profile.arena_baseline_games) : "n/a"],
