    ...
    const sections = [
        ...
        [
            ...
            [
                ...
                ["Geometry Loss", fmtLoss(state.running_geometry_loss || state.last_geometry_loss)],
        ...
        [
            ...
            [
                ...
                ["Geometry Loss", fmtLoss(state.last_geometry_loss)],
                ["Attack Loss", fmtLoss(state.last_attack_loss)],
                ["Pressure Loss", fmtLoss(state.last_pressure_loss)],
